metrics_resource = {
    ...
    "Gls_90": "Goals per 90 minutes played.",
    ...
    "npxG_90": "Non-penalty xG per 90 minutes.",
    "npxG+xAG_90": "Non-penalty xG and xAG per 90 minutes.",
    ...
    "PassLive_90": "Live-ball passes per 90 minutes.",
    "PassDead_90": "Dead-ball passes per 90 minutes.",
